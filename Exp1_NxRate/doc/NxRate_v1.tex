...
\begin{figure}[h!] 
\includegraphics[scale=0.8]{/N_runVar}
\caption{\hl{Results from 1st flume experiment showing among-run variation in fertilization succcess as a function }}
\label{fig:flume1}
\end{figure}
\newpage{}
...
\begin{figure}[h!] 
\includegraphics[scale=0.8]{/NxRatexEggPos_prelim_m3}
\caption{\hl{Results from 2nd flume experiment showing sperm released $\times$ release rate $\times$ egg position interaction.}}
\label{fig:flume2ixn}
\end{figure}
\newpage{}
...
\begin{figure}[h!] 
\includegraphics[scale=0.8]{/NxRate_perCapita}
\caption{\hl{Results from 2nd flume experiment showing per-capita fertilization success as a function of sperm released $\times$ release rate .}}
\label{fig:flume2perCapita}
\end{figure}
\newpage{}
