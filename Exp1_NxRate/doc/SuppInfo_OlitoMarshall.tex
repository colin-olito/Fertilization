...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Supporting Information (Appendices A \& B) for: Sperm release strategies are overdetermined in broadcast spawners: selection during sperm dispersal and sperm competition favour similar reproductive phenotypes. \textit{Evolution}}
...
\end{tabular}
\smallskip{} \\
{\footnotesize Note: Bold indicates the final model selected, while daggers indicate other\\ competitive candidate models with a similar fit to the data, but more terms\\ than the final model.}
\end{table}
...
\begin{figure}[!ht]
\includegraphics[width=\textwidth]{./NxRate_SimpContrasts_Bin}
